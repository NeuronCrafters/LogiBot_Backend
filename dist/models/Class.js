...
ClassSchema.pre("findOneAndDelete", function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        const classDoc = yield this.model.findOne(this.getFilter());
        if (classDoc) {
            yield mongoose_1.default.model("Course").findByIdAndUpdate(classDoc.course, {
