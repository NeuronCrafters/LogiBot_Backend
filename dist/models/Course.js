...
const CourseSchema = new mongoose_1.Schema({
    ...
    university: { type: mongoose_1.default.Schema.Types.ObjectId, ref: "University", required: true },
...
CourseSchema.pre("findOneAndDelete", function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        const course = yield this.model.findOne(this.getFilter());
        if (course) {
            yield mongoose_1.default.model("University").findByIdAndUpdate(course.university, {
