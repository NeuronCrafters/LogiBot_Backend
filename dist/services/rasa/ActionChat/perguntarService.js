...
exports.actionPerguntarService = actionPerguntarService;
const axios_1 = __importDefault(require("axios"));
const AppError_1 = require("../../../exceptions/AppError");
const RASA_ACTION_URL = process.env.RASA_ACTION;
function actionPerguntarService(userText, senderId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            throw new AppError_1.AppError("Erro ao conversar com o assistente de lógica", 500);
        }
    });
}
