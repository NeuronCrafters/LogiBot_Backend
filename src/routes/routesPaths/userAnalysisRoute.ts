...
import { GetUserAnswerController } from "../../controllers/userAnalysis/getUserAnswerController";
...
userAnalysisRouter.get("/user-analysis/get-user-answer", new GetUserAnswerController().handle);
